...
Diese Studienarbeit soll nun diese Metriken genauer untersuchen. Hierbei ist es zunächst wichtig die verschiedenste Metriken vorzustellen und zu erläutern. Dabei ist es auch wichtig herauszufinden, wie verbreitet diese Metriken sind und inwieweit die jeweiligen Kennzahlen zu bewerten sind. Des Weiteren soll auf Basis der Metriken auch der Begriff der Isomorphie bzw. Ähnlichkeit von Graphen aufgegriffen werden.
...
\singleenum{5}{Welche realen Anwendungen gibt es für Graph-Metriken und den Vergleich von Graphen (Ähnlichkeit)?}
